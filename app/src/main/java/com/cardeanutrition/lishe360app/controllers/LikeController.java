...
package com.cardeanutrition.lishe360app.controllers;
...
public class LikeController {
    ...
    private void addLike(long prevValue) {
        ...
        isLiked = true;
        likeCounterTextView.setText(String.valueOf(prevValue + 1)+ " Likes");
    ...
    private void showWarningMessage(BaseActivity baseActivity, int messageId) {
        if (baseActivity instanceof MainActivity) {
          //  ((ProductsActivity) baseActivity).showFloatButtonRelatedSnackBar(messageId);
        } else {
