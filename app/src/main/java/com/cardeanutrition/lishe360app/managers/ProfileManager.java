...
import com.cardeanutrition.lishe360app.activities.CreateProfileActivity;
...
public class ProfileManager extends FirebaseListenersManager {
    ...
    public void createOrUpdateProfile(Profile profile, Uri imageUri, OnProfileCreatedListener onProfileCreatedListener) {
        createOrUpdateProfile(profile, null, onProfileCreatedListener);
    }

    public void createOrUpdateProfile(final Profile profile, Uri imageUri, final CreateProfileActivity onProfileCreatedListener) {
        if (imageUri == null) {
