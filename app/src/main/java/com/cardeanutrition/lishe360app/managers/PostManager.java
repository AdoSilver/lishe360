...
import com.cardeanutrition.lishe360app.enums.UploadImagePrefix;
...
import com.cardeanutrition.lishe360app.utils.ImageUtil;
...
public class PostManager extends FirebaseListenersManager {
    ...
    public void createOrUpdatePostWithImage(Uri imageUri, final CreatePostActivity onPostCreatedListener, final Post post) {
