...
package com.cardeanutrition.lishe360app.managers;
...
import com.cardeanutrition.lishe360app.ApplicationHelper;
import com.cardeanutrition.lishe360app.Constants;
...
import com.cardeanutrition.lishe360app.managers.listeners.OnPostListChangedListener;
...
import com.cardeanutrition.lishe360app.model.PostListResult;
...
//        Sets the maximum time to retry upload operations if a failure occurs.
    ...
    public Task<Void> removeImage(String imageTitle) {
        StorageReference storageRef = storage.getReferenceFromUrl("gs://lishe360app.appspot.com");
