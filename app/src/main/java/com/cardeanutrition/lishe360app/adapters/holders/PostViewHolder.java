...
package com.cardeanutrition.lishe360app.adapters.holders;
...
public class PostViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bindData(Post post) {
        ...
        likeCounterTextView.setText(String.valueOf(post.getLikesCountString()));
        commentsCountTextView.setText(String.valueOf(post.getCommentsCountString()));
        usernameTextView.setText("Author No: "+post.getAuthorId());
